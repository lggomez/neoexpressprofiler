...
namespace ExpressProfiler
{
    internal class Sqltokens
    {
        ...
        private const string Functions =
            ...
            + "DIFFERENCE,EXP,FILEGROUPPROPERTY,FILEGROUP_ID,FILEGROUP_NAME,FILEPROPERTY," + "FILE_ID,FILE_NAME,FLOOR"
            ...
            + "LOG10,LOWER,LTRIM,MONTH,NEWID,OBJECTPROPERTY,OBJECT_ID," + "OBJECT_NAME,PARSENAME,PATINDEX,"
            ...
            + "TAN,TEXTPTR,TEXTVALID,TYPEPROPERTY,UNICODE,UPPER," + "USER_ID,USER_NAME,VAR,VARP,YEAR";
        ...
        private const string Keywords =
            ...
            + "CHECK,CHECKPOINT,CLOSE,CLUSTERED,COLLATE," + "COLUMN,COMMIT,COMPUTE,CONSTRAINT,CONTAINS,CONTAINSTABLE,"
            + "CONTINUE,CREATE,CURRENT,CURSOR,DATABASE," + "DBCC,DEALLOCATE,DECLARE,DEFAULT,DELETE,DENY,DESC,DISK,"
        ...
        private const string Types =
            "bigint,binary,bit,char,character,datetime," + "dec,decimal,float,image,int,"
            + "integer,money,nchar,ntext,nvarchar,real," + "rowversion,smalldatetime,smallint,smallmoney,"
            + "sql_variant,sysname,text,timestamp,tinyint,uniqueidentifier," + "varbinary,varchar,NUMERIC";
