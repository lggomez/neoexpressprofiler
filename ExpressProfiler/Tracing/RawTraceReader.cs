...
namespace ExpressProfiler
{
    ...
    public static class ProfilerEvents
    {
        ...
        */
        ...
        public static readonly string[] EventNames = new string[202]
...
// ReSharper restore UnusedMember.Global
        ...
        {
            var cmd = new SqlCommand{Connection = m_Conn,CommandText = "sp_trace_setevent",CommandType = CommandType.StoredProcedure};
...
// ReSharper restore UnusedMember.Global
        {
            var cmd = new SqlCommand { Connection = m_Conn, CommandText = "sp_trace_setfilter", CommandType = CommandType.StoredProcedure };
            cmd.Parameters.Add("@traceid", SqlDbType.Int).Value = m_TraceId;
        ...
        {
            var cmd = new SqlCommand { Connection = m_Conn, CommandText = "sp_trace_create", CommandType = CommandType.StoredProcedure };
        ...
        {
            var cmd = new SqlCommand { Connection = con, CommandText = "sp_trace_setstatus", CommandType = CommandType.StoredProcedure,CommandTimeout = 0};
            cmd.Parameters.Add("@traceid", SqlDbType.Int).Value = m_TraceId;
        ...
        {
            var cmd = new SqlCommand { Connection = m_Conn, CommandText = "sp_trace_getdata", CommandType = CommandType.StoredProcedure,CommandTimeout = 0};
            cmd.Parameters.Add("@traceid", SqlDbType.Int).Value = m_TraceId;
        ...
        public ProfilerEvent Next()
        {
            ...
            if (eventClass >= 0 && eventClass < 255)
            {
                ...
                profilerEvent.m_Events[27] = eventClass;
                profilerEvent.m_ColumnMask |= 1 << 27;

                while (Read())
                {
                    columnid = (int)m_Reader[0];
                    if (columnid > 64) return profilerEvent;
                    m_Delegates[columnid](profilerEvent, columnid);
                }
            }
